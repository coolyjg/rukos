...
# How to test?
- Use `redis-cli -p 5555` to connect to redis-server, and enjoy Rukos-Redis world!
...
- Enter `grub` then boot the PC by Rukos Redis.
- Connect to Rukos-Redis server by:
