...
pub fn reset_qspi() {
    ...
    let ptr = phys_to_virt((ruxconfig::A1000BASE_SAFETYCRM + 0x8).into()).as_mut_ptr() as *mut u32;
    unsafe {
...
pub fn get_bootmode() -> u32 {
    unsafe {
        let ptr = phys_to_virt((ruxconfig::A1000BASE_TOPCRM).into()).as_mut_ptr() as *mut u32;
